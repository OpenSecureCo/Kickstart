...
rm -rf /var/ossec/
WAZUH_MANAGER='demo.opensecure.co' WAZUH_AGENT_GROUP='default' yum install https://packages.wazuh.com/4.x/yum/wazuh-agent-4.2.4-1.x86_64.rpm -y
echo "logcollector.remote_commands=1" >> /var/ossec/etc/local_internal_options.conf
echo "<ossec_config>
    <client>
    <server>
      <address>demo.opensecure.co</address>
      <port>1514</port>
